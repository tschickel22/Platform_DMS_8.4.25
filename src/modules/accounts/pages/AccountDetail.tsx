...
// Import additional account sections
import { AccountAgreementsSection } from '@/modules/agreement-vault/components/AccountAgreementsSection'
import { AccountInvoicesSection } from '@/modules/invoice-payments/components/AccountInvoicesSection'
...
import { AccountApplicationsSection } from '@/modules/finance-application/components/AccountApplicationsSection'
...
const coreSections: AccountSection[] = [
  ...
  },
  {
    ...
    description: 'Warranty claims and coverage',
