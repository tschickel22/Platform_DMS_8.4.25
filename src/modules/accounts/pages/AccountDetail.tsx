...
export default function AccountDetail() {
  ...
  const accountContacts = accountId ? getContactsByAccount(accountId) : []
      ...
      <div className="space-y-6">
        <div className="ri-page-header">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="ri-page-title">Account Not Found</h1>
              <p className="ri-page-description">The requested account could not be found.</p>
            </div>
          </div>
        </div>
      </div>
