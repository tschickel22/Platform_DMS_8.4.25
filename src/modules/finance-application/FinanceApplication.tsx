...
export function FinanceApplicationForm({
  ...
  const { getTemplateById, templates = [] } = useFinanceApplications() as any
  ...
  const template = (getTemplateById?.(application.templateId)) ?? (templates.find((t:any)=>t.id===application.templateId))
