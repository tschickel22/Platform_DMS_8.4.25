...
export default function InventoryManagement() {
  ...
  // Brochure modal control (single source of truth)
  ...
  return (
    <ErrorBoundary>
      <TooltipProvider delayDuration={200}>
        ...
        {/* Brochure Modal — controlled exclusively by showBrochureModal */}
        <ErrorBoundary>
          {showBrochureModal && (
            <GenerateBrochureModal
              // If your modal supports these props, great; otherwise it will ignore extras.
              open={showBrochureModal as any}
              onOpenChange={(open: boolean) => setShowBrochureModal(open)}
              onClose={handleCloseBrochureModal}
              // Pass context if your modal expects selected items
