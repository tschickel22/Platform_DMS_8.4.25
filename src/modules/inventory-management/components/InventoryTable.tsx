...
interface InventoryTableProps {
  ...
  /** Optional: if provided, shows a "Generate Brochure" item that calls this */
  onGenerateBrochure?: (vehicle: any) => void
}
      ...
      <Table>
        ...
        <TableBody>
          {vehicles.map((vehicle: any) => {
            ...
            const statusText =
              vehicle?.status ||
              vehicle?.availability || // some RV data uses availability
              'Unknown'
