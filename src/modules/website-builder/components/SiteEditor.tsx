...
export default function PageList({
  ...
  const saveEditing = () => {
    if (!editingPageId || !onEditPage) return
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-2">
        <Button size="sm" onClick={() => onCreatePage({ name: 'New Page', slug: 'new-page' })}>
        ...
        {filteredPages.length === 0 ? (
          <Card className="border-dashed">
            <CardContent className="flex flex-col items-center justify-center py-8 text-center">
              ...
              {!searchTerm && (
                <Button size="sm" variant="outline" onClick={() => onCreatePage({ name: 'First Page', slug: 'first-page' })} className="mt-2">
                  <Plus className="h-4 w-4 mr-2" />
                  Create First Page
                </Button>
              )}
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem
                          onClick={(e) => {
                            e.stopPropagation()
                            onEditPage(page.id, { name: page.name, slug: page.slug })
                          }}
                        >
