...
import { getConversionColor } from '@/utils/colorUtils'
...
export function DealMetrics({ metrics }: DealMetricsProps) {
  ...
  // Use provided metrics, fallback to tenant metrics, then mock data
  const displayMetrics = metrics || tenant?.dealMetrics || mockCrmSalesDeal.metrics
