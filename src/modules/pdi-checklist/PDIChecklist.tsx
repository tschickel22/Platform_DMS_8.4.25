...
function PropertyListingsDashboard() {
  ...
  // Treat "Average Price" as a quick link to show premium homes
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Stats (PDI-style colors + clickable filters) */}
      <div className="grid gap-4 md:grid-cols-3">
        ...
        {/* Premium shortcut via Avg Price */}
        <Card
      ...
      {filtered.length > 0 ? (
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {filtered.map((listing) => (
            <Card
              key={listing?.id ?? `${listing?.make}-${listing?.model}`}
              className="overflow-hidden hover:shadow-lg transition-shadow"
            >
              <div
                className="relative cursor-pointer"
                onClick={() => navigate(`/property/listings/${listing?.id ?? ''}`)}
              >
                <img
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2 pt-2">
                    ...
                    <Button
                      ...
                      size="sm"
                      className="flex-1"
                      onClick={() => navigate(`/property/listings/${listing?.id ?? ''}?edit=1`)}
                    >
                    ...
                    <Button
                      ...
                      size="sm"
                      className="flex-1"
                      onClick={() => alert('Delete not implemented in mock')}
                    >
